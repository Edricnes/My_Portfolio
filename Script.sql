-- 1. First order of business, let's see what the data has to offer
...
-- 8. Now let's start breaking our queries by the continents
...
-- Now, we want to prepare some data for data visualization purposes, which I'll do in the next one with Tableau
-- Vis_1
